define([], function() {
	...
	var configuration = {
		...
		route: [
			{'state': 'dashboardGlusterfs', 'url': CONTEXT_ROOT, 'templateUrl': PARTIALS_ROOT + 'dashboard.glusterfs.index.php', 'controller': 'DashboardGlusterfsCtrl'},
			{'state': 'dashboardGlusterfs.workbench', 'url': '/workbench', 'templateUrl': PARTIALS_ROOT + 'dashboard.glusterfs.workbench.php', 'controller': 'DashboardGlusterfsWorkbenchCtrl'},
			{'state': 'dashboardGlusterfs.node', 'url': '/node', 'templateUrl': PARTIALS_ROOT + 'dashboard.glusterfs.node.php', 'controller': 'DashboardGlusterfsNodeCtrl'},
			{'state': 'dashboardGlusterfs.brick', 'url': '/brick', 'templateUrl': PARTIALS_ROOT + 'dashboard.glusterfs.brick.php', 'controller': 'DashboardGlusterfsBrickCtrl'},
