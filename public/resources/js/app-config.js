define([], function() {
	...
	var configuration = {
		...
		route: [
			...
			{'state': 'dashboardGlusterfsList', 'url': CONTEXT_ROOT + '/glusterfs', 'templateUrl': PARTIALS_ROOT + 'dashboard.glusterfs.index.php', 'controller': 'DashboardGlusterfsListCtrl'},
			{'state': 'dashboardGlusterfsList.storage', 'url': '/storage', 'templateUrl': PARTIALS_ROOT + 'dashboard.glusterfs.storage.php', 'controller': 'DashboardGlusterfsListCtrl'},
			...
			// {'state': 'dashboardGlusterfsList.brick', 'url': '/brick', 'templateUrl': PARTIALS_ROOT + 'dashboard.glusterfs.brick.php', 'controller': 'DashboardGlusterfsBrickCtrl'},
			{'state': 'dashboardGlusterfsList.network', 'url': '/network', 'templateUrl': PARTIALS_ROOT + 'dashboard.glusterfs.network.php', 'controller': 'DashboardGlusterfsListCtrl'},
			{'state': 'hostList', 'url': CONTEXT_ROOT + '/hosts?:current_state:has_been_checked', 'templateUrl': PARTIALS_ROOT + 'host.index.php', 'controller': 'HostListCtrl'},
			{'state': 'hostShow', 'url': CONTEXT_ROOT + '/hosts/:uuid', 'templateUrl': PARTIALS_ROOT + 'host.show.php', 'controller': 'HostShowCtrl'},
			{'state': 'serviceList', 'url': CONTEXT_ROOT + '/services?:current_state:has_been_checked', 'templateUrl': PARTIALS_ROOT + 'service.index.php', 'controller': 'ServiceListCtrl'},
			...
			{'state': 'systemConfigurationHostgroupList', 'url': CONTEXT_ROOT + '/configuration/hostgroups', 'templateUrl': PARTIALS_ROOT + 'system.configuration.hostgroup.index.php', 'controller': 'SystemConfigurationHostgroupListCtrl'},
			{'state': 'systemConfigurationHostgroupCreation', 'url': CONTEXT_ROOT + '/configuration/hostgroups/create', 'templateUrl': PARTIALS_ROOT + 'system.configuration.hostgroup.create.php', 'controller': 'SystemConfigurationHostgroupCreationCtrl'},
