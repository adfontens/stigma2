<div class="col-md-11 col-md-offset-1">
	...
	<div>
		<table class="table table-striped table-hover">
			...
			<tbody>
				<tr ng-repeat="service in filteredServices = (services | filter: {current_state: current_state})" ng-show="filteredServices.length">
					...
					<td ng-if="service.current_state === '0' && service.last_check !== '0'">OK</td>
					...
					<td ng-if="service.current_state === '0' && service.last_check === '0'">Pending</td>
					<td><span  ng-hide="service.last_check === '0'">{{ formatDate(service.last_check) }}</span></td>
					<td><span  ng-hide="service.last_check === '0'">{{ formatDuration(service.last_state_change) }}</span></td>
					<td><span  ng-hide="service.last_check === '0'">{{ service.current_attempt }} / {{ service.max_attempts }}</span></td>
					<td><span  ng-hide="service.last_check === '0'">{{ service.plugin_output }}</span></td>
				</tr>
